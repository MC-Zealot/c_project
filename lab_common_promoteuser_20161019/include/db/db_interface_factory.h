...
//#include "nspio_db_interface.h"
//#include "spio_db_interface.h"
		...
		DbInterface* get_db_interface(const Db_Info_Struct& db_info_struct){
			...
			switch(db_info_struct.db_type_){
				...
				case MC_DB_TYPE:
					...
					break;
				/*case NSPIO_DB_TYPE:
					p_db_interface = new NspioDbInterface(db_info_struct);
					break;
				case SPIO_DB_TYPE:
					p_db_interface = new SpioDbInterface(db_info_struct);
					break;*/
				default:
					break;	
			}
