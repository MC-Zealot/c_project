#ifndef _FANSTARGETIDX_WORK_INTERFACE_HEADER_
#define _FANSTARGETIDX_WORK_INTERFACE_HEADER_
...
class FansTargetIdxWorkInterface : public WorkInterface {
	private:
		const static int DEFAULT_IP_CODE = 30000;	
	public:
		FansTargetIdxWorkInterface(DbCompany*& p_db_company, int interface_id):
				WorkInterface(p_db_company,interface_id)
		{}
		
		~FansTargetIdxWorkInterface()
		{}
