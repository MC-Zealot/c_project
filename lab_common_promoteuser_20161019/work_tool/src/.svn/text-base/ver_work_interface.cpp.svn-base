#include "ver_work_interface.h"

DYN_WORK(VerWorkInterface);
int VerWorkInterface::work_core(json_object *req_json, char* &p_out_string, int& n_out_len, uint64_t req_id){
	...
	if(strcasecmp(cmd_str, "query") == 0){
		...
		//return return_fail(409, "The test of changing so!", p_out_string, n_out_len);
