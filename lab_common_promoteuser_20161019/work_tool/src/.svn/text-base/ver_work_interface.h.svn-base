#ifndef _VER_WORK_INTERFACE_HEADER_
#define _VER_WORK_INTERFACE_HEADER_
...
class VerWorkInterface : public UserWorkInterface{
	public:
		VerWorkInterface(DbCompany*& p_db_company, int interface_id):
